			...
			<div class="navbar-end">
				...
				<div class="dropdown dropdown-end inline-block">
					...
					<ul tabindex="-1" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
						<li><a href="#top" on:click={() => (theme = 'light')}>light</a></li>
						<li><a href="#top" on:click={() => (theme = 'dark')}>dark</a></li>
						<li><a href="#top" on:click={() => (theme = 'retro')}>retro</a></li>
					</ul>
				</div>
				<button class="btn btn-ghost btn-circle">
					<div class="indicator">
				...
				<div class="dropdown dropdown-end inline-block">
					...
					<ul tabindex="-1" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
						<li>
							<a href="#top" class="justify-between">
								Profile
