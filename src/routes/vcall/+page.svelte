<script lang="ts">
	...
	let renderYouwebcam = (stream: any) => {
		console.log(stream);
...
<div>
	...
	<br />
	code :
	<input type="" bind:value={codeid} name="" />
	...
	<video bind:this={videoEl} width="400" height="400">
		<track kind="captions" src="" />
	</video>
	<br />

	<!-- YOU FACE CAM HERE -->
	<video bind:this={videocurrent} width="400" height="400">
		<track kind="captions" src="" />
	</video>
</div>
